Shader "Hidden/MSRP/TAA"
{
    ...
    {
        return SAMPLE_TEXTURE2D_LOD(_MainTex, sampler_LinearClamp, screenUV, 0);
    }
    ...
    VaryingsCopy DefaultPassVertex(uint vertexID : SV_VertexID)
    {
        VaryingsCopy output;
    ...
    float4 CopyPassFragment(VaryingsCopy input) : SV_TARGET
    {
